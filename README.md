...
![image](https://github.com/user-attachments/assets/b392c25b-1adb-441a-94f0-5046801b0d39)

And this graph has a logaritming form due to ordering data from highest to lowest similraity of the vectors from this movies
![image](https://github.com/user-attachments/assets/ff9cbcd3-b2ab-4719-aaa1-d1ab430d4fe7)
